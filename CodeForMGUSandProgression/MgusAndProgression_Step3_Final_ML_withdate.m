...
for i = 1:sum(test_cohort)
    ...
    if any(abs(datenum(True_MGUS_date{this_test}) -  datenum(earliest_timeMGUS_te{i}))<=Days_diff)
        ...
        if any(abs(datenum(True_MGUS_date{this_test}) -  datenum(earliest_timeMGUS_te{i}))>45)
            TP_test_MGUS(i) = 0;
            FP_test_MGUS(i) = 1;
        end
    ...
    if any(abs(datenum(True_MM_date{this_test}) -  datenum(earliest_timeMM_te{i}))<=Days_diff)
        % check value for the matched date
        if any(abs(datenum(True_MM_date{this_test}) -  datenum(earliest_timeMM_te{i}))>45)
            TP_test_MM(i) = 0;
            FP_test_MM(i) = 1;
        end
...
for i = 1:sum(valid_cohort)
    ...
    if any(abs(datenum(True_MGUS_date{this_valid}) -  datenum(earliest_timeMGUS_va{i}))<=Days_diff)
        % check value for the matched date
        if any(abs(datenum(True_MGUS_date{this_valid}) -  datenum(earliest_timeMGUS_va{i}))>45)
            TP_valid_MGUS(i) = 0;
            FP_valid_MGUS(i) = 1;
        end
    ...
    if any(abs(datenum(True_MM_date(this_valid)) -  datenum(earliest_timeMM_va{i}))<=Days_diff)
        if any(abs(datenum(True_MM_date(this_valid)) -  datenum(earliest_timeMM_va{i}))>45)
            TP_valid_MM(i) = 0;
            FP_valid_MM(i) = 1;
        end
...
writetable(array2table(MGUS_SVM),'Ressults20230112_date.xlsx','Sheet','MGUS_SVM')
writetable(array2table(MM_SVM),'Ressults20230112_date.xlsx','Sheet','MM_SVM')
%% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Random forest - MGUS
...
writetable(array2table(MGUS_RF),'Ressults20230112_date.xlsx','Sheet','MGUS_RF')
writetable(array2table(MM_RF),'Ressults20230112_date.xlsx','Sheet','MM_RF')
...
writetable(array2table(MGUS_LG),'Ressults20230112_date.xlsx','Sheet','MGUS_LG')
writetable(array2table(MM_LG),'Ressults20230112_date.xlsx','Sheet','MM_LG')
...
writetable(array2table(MGUS_ICD),'Ressults20221227.xlsx','Sheet','MGUS_ICD')
...
writetable(array2table(MM_ICD),'Ressults20221227.xlsx','Sheet','MM_ICD')
